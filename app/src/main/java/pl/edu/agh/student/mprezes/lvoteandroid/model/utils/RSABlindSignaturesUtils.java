package pl.edu.agh.student.mprezes.lvoteandroid.model.utils;
...
public class RSABlindSignaturesUtils {
     ...
     */
    public static RSABlindingParameters generateRSABlindingParameters(AsymmetricKeyParameter publicKey) {
     ...
     *
     * @param message            String message to blind
     * @param blindingParameters parameters needed to blind message
     * @return RSABlindedMessage
     * @throws CryptoException in case of any blinding problems
     */
    public static RSABlindedMessage blindMessage(String message, RSABlindingParameters blindingParameters) throws CryptoException {
     ...
     *
     * @param blindedMessage RSABlindedMessage
     * @param privateKey     signer private RSA key
    ...
    private static String bytesToString(byte[] text) {
        try {
